...
class Model(object):
  ...
  ncep_hgefs025_ensemble_mean = cast(int, ...)
  ecmwf_seasonal_ensemble_mean_seamless = cast(int, ...)
  ecmwf_seas5_ensemble_mean = cast(int, ...)
  ecmwf_ec46_ensemble_mean = cast(int, ...)
  ncep_aigefs025_ensemble_mean = cast(int, ...)
  dwd_icon_eps_ensemble_mean_seamless = cast(int, ...)
  dwd_icon_eps_ensemble_mean = cast(int, ...)
  dwd_icon_eu_eps_ensemble_mean = cast(int, ...)
  dwd_icon_d2_eps_ensemble_mean = cast(int, ...)
  ncep_gefs_ensemble_mean_seamless = cast(int, ...)
  ncep_gefs025_ensemble_mean = cast(int, ...)
  ncep_gefs05_ensemble_mean = cast(int, ...)
  ecmwf_ifs025_ensemble_mean = cast(int, ...)
  ecmwf_aifs025_ensemble_mean = cast(int, ...)
  meteoswiss_icon_ch1_ensemble_mean = cast(int, ...)
  meteoswiss_icon_ch2_ensemble_mean = cast(int, ...)
