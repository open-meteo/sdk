...
class WeatherApiResponse : Table() {
    ...
    val weekly : com.openmeteo.sdk.VariablesWithTime? get() = weekly(com.openmeteo.sdk.VariablesWithTime())
    fun weekly(obj: com.openmeteo.sdk.VariablesWithTime) : com.openmeteo.sdk.VariablesWithTime? {
        val o = __offset(32)
        return if (o != 0) {
            obj.__assign(__indirect(o + bb_pos), bb)
        } else {
    ...
    companion object {
        ...
        fun createWeatherApiResponse(builder: FlatBufferBuilder, latitude: Float, longitude: Float, elevation: Float, generationTimeMilliseconds: Float, locationId: Long, model: UByte, utcOffsetSeconds: Int, timezoneOffset: Int, timezoneAbbreviationOffset: Int, currentOffset: Int, dailyOffset: Int, hourlyOffset: Int, minutely15Offset: Int, monthlyOffset: Int, weeklyOffset: Int) : Int {
            builder.startTable(15)
            addLocationId(builder, locationId)
            addWeekly(builder, weeklyOffset)
        ...
        fun addWeekly(builder: FlatBufferBuilder, weekly: Int) = builder.addOffset(14, weekly, 0)
