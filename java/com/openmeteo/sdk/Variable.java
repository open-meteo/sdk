...
public final class Variable {
  ...
  public static final int cloud_base = 110;
  ...
  public static final int thunderstorm_probability = 125;
  public static final int rain_probability = 126;
  ...
  public static final int sea_level_height_msl = 132;
  public static final int sea_surface_temperature = 133;
  public static final int invert_barometer_height = 134;
  public static final int hail = 135;
  public static final int albedo = 136;
  public static final int precipitation_type = 137;
  public static final int convective_cloud_base = 138;
  public static final int convective_cloud_top = 139;
  public static final int snow_depth_water_equivalent = 140;
  public static final int secondary_swell_wave_height = 141;
  public static final int secondary_swell_wave_period = 142;
  public static final int secondary_swell_wave_peak_period = 143;
  public static final int secondary_swell_wave_direction = 144;
  public static final int tertiary_swell_wave_height = 145;
  public static final int tertiary_swell_wave_period = 146;
  public static final int tertiary_swell_wave_peak_period = 147;
  public static final int tertiary_swell_wave_direction = 148;
  public static final int wind_u_component = 149;
  public static final int wind_v_component = 150;
  public static final int temperature_max24h = 151;
  public static final int temperature_min24h = 152;
  public static final int temperature_mean24h = 153;
  public static final int snow_density = 154;
  public static final int longwave_radiation = 155;
  public static final int sea_ice_cover = 156;
  public static final int k_index = 157;
  public static final int roughness_length = 158;
  public static final int potential_evapotranspiration = 159;
  public static final int wave_peak_period = 160;
  public static final int temperature_max6h = 161;
  public static final int temperature_min6h = 162;
  public static final int lightning_density = 163;
  public static final int sea_ice_thickness = 164;
  public static final int shortwave_radiation_clear_sky_instant = 165;
  public static final int sea_water_salinity = 166;
  public static final int total_column_water = 167;
  public static final int air_density = 168;
  public static final int moonrise = 169;
  public static final int moonset = 170;
  public static final int moon_phase = 171;

  public static final String[] names = { "undefined", "apparent_temperature", "cape", "cloud_cover", "cloud_cover_high", "cloud_cover_low", "cloud_cover_mid", "daylight_duration", "dew_point", "diffuse_radiation", "diffuse_radiation_instant", "direct_normal_irradiance", "direct_normal_irradiance_instant", "direct_radiation", "direct_radiation_instant", "et0_fao_evapotranspiration", "evapotranspiration", "freezing_level_height", "growing_degree_days", "is_day", "latent_heat_flux", "leaf_wetness_probability", "lifted_index", "lightning_potential", "precipitation", "precipitation_hours", "precipitation_probability", "pressure_msl", "rain", "relative_humidity", "runoff", "sensible_heat_flux", "shortwave_radiation", "shortwave_radiation_instant", "showers", "snow_depth", "snow_height", "snowfall", "snowfall_height", "snowfall_water_equivalent", "sunrise", "sunset", "soil_moisture", "soil_moisture_index", "soil_temperature", "surface_pressure", "surface_temperature", "temperature", "terrestrial_radiation", "terrestrial_radiation_instant", "total_column_integrated_water_vapour", "updraft", "uv_index", "uv_index_clear_sky", "vapour_pressure_deficit", "visibility", "weather_code", "wind_direction", "wind_gusts", "wind_speed", "vertical_velocity", "geopotential_height", "wet_bulb_temperature", "river_discharge", "wave_height", "wave_period", "wave_direction", "wind_wave_height", "wind_wave_period", "wind_wave_peak_period", "wind_wave_direction", "swell_wave_height", "swell_wave_period", "swell_wave_peak_period", "swell_wave_direction", "pm10", "pm2p5", "dust", "aerosol_optical_depth", "carbon_monoxide", "nitrogen_dioxide", "ammonia", "ozone", "sulphur_dioxide", "alder_pollen", "birch_pollen", "grass_pollen", "mugwort_pollen", "olive_pollen", "ragweed_pollen", "european_aqi", "european_aqi_pm2p5", "european_aqi_pm10", "european_aqi_nitrogen_dioxide", "european_aqi_ozone", "european_aqi_sulphur_dioxide", "us_aqi", "us_aqi_pm2p5", "us_aqi_pm10", "us_aqi_nitrogen_dioxide", "us_aqi_ozone", "us_aqi_sulphur_dioxide", "us_aqi_carbon_monoxide", "sunshine_duration", "convective_inhibition", "shortwave_radiation_clear_sky", "global_tilted_irradiance", "global_tilted_irradiance_instant", "ocean_current_velocity", "ocean_current_direction", "cloud_base", "cloud_top", "mass_density", "boundary_layer_height", "formaldehyde", "glyoxal", "non_methane_volatile_organic_compounds", "pm10_wildfires", "peroxyacyl_nitrates", "secondary_inorganic_aerosol", "residential_elementary_carbon", "total_elementary_carbon", "pm2_5_total_organic_matter", "sea_salt_aerosol", "nitrogen_monoxide", "thunderstorm_probability", "rain_probability", "freezing_rain_probability", "ice_pellets_probability", "snowfall_probability", "carbon_dioxide", "methane", "sea_level_height_msl", "sea_surface_temperature", "invert_barometer_height", "hail", "albedo", "precipitation_type", "convective_cloud_base", "convective_cloud_top", "snow_depth_water_equivalent", "secondary_swell_wave_height", "secondary_swell_wave_period", "secondary_swell_wave_peak_period", "secondary_swell_wave_direction", "tertiary_swell_wave_height", "tertiary_swell_wave_period", "tertiary_swell_wave_peak_period", "tertiary_swell_wave_direction", "wind_u_component", "wind_v_component", "temperature_max24h", "temperature_min24h", "temperature_mean24h", "snow_density", "longwave_radiation", "sea_ice_cover", "k_index", "roughness_length", "potential_evapotranspiration", "wave_peak_period", "temperature_max6h", "temperature_min6h", "lightning_density", "sea_ice_thickness", "shortwave_radiation_clear_sky_instant", "sea_water_salinity", "total_column_water", "air_density", "moonrise", "moonset", "moon_phase", };
