...
public struct openmeteo_sdk_TimeRange: NativeStruct, Verifiable, FlatbuffersInitializable {
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    try verifier.inBuffer(position: position, of: openmeteo_sdk_TimeRange.self)
  }
}

public struct openmeteo_sdk_TimeRange_Mutable: FlatBufferObject {
...
public struct openmeteo_sdk_ValueAndUnit: NativeStruct, Verifiable, FlatbuffersInitializable {
  ...
  public init(value: Float32, unit: openmeteo_sdk_SiUnit) {
    _value = value
    _unit = unit.value
  }
  ...
  public var unit: openmeteo_sdk_SiUnit { openmeteo_sdk_SiUnit(rawValue: _unit)! }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    try verifier.inBuffer(position: position, of: openmeteo_sdk_ValueAndUnit.self)
  }
}

public struct openmeteo_sdk_ValueAndUnit_Mutable: FlatBufferObject {
  ...
  public var unit: openmeteo_sdk_SiUnit { return openmeteo_sdk_SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: 4)) ?? .undefined }
}

public struct openmeteo_sdk_ValuesAndUnit: FlatBufferObject, Verifiable {
  ...
  public static func createValuesAndUnit(
    ...
    let __start = openmeteo_sdk_ValuesAndUnit.startValuesAndUnit(&fbb)
    openmeteo_sdk_ValuesAndUnit.addVectorOf(values: values, &fbb)
    openmeteo_sdk_ValuesAndUnit.add(unit: unit, &fbb)
    return openmeteo_sdk_ValuesAndUnit.endValuesAndUnit(&fbb, start: __start)
  }
...
public struct openmeteo_sdk_ValuesAndMember: FlatBufferObject, Verifiable {
  ...
  public static func createValuesAndMember(
    ...
    let __start = openmeteo_sdk_ValuesAndMember.startValuesAndMember(&fbb)
    openmeteo_sdk_ValuesAndMember.add(member: member, &fbb)
    openmeteo_sdk_ValuesAndMember.addVectorOf(values: values, &fbb)
    return openmeteo_sdk_ValuesAndMember.endValuesAndMember(&fbb, start: __start)
  }
...
public struct openmeteo_sdk_ValuesUnitAndMember: FlatBufferObject, Verifiable {
  ...
  public var hasValues: Bool { let o = _accessor.offset(VTOFFSET.values.v); return o == 0 ? false : true }
  public var valuesCount: Int32 { let o = _accessor.offset(VTOFFSET.values.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func values(at index: Int32) -> openmeteo_sdk_ValuesAndMember? { let o = _accessor.offset(VTOFFSET.values.v); return o == 0 ? nil : openmeteo_sdk_ValuesAndMember(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
  ...
  public static func createValuesUnitAndMember(
    ...
    let __start = openmeteo_sdk_ValuesUnitAndMember.startValuesUnitAndMember(&fbb)
    openmeteo_sdk_ValuesUnitAndMember.add(unit: unit, &fbb)
    openmeteo_sdk_ValuesUnitAndMember.addVectorOf(values: values, &fbb)
    return openmeteo_sdk_ValuesUnitAndMember.endValuesUnitAndMember(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.unit.p, fieldName: "unit", required: false, type: openmeteo_sdk_SiUnit.self)
    try _v.visit(field: VTOFFSET.values.p, fieldName: "values", required: false, type: ForwardOffset<Vector<ForwardOffset<openmeteo_sdk_ValuesAndMember>, openmeteo_sdk_ValuesAndMember>>.self)
    _v.finish()
  }
}

public struct openmeteo_sdk_ValuesAndLevelAndMember: FlatBufferObject, Verifiable {
  ...
  public static func createValuesAndLevelAndMember(
    ...
    let __start = openmeteo_sdk_ValuesAndLevelAndMember.startValuesAndLevelAndMember(&fbb)
    openmeteo_sdk_ValuesAndLevelAndMember.add(level: level, &fbb)
    openmeteo_sdk_ValuesAndLevelAndMember.addVectorOf(values: values, &fbb)
    return openmeteo_sdk_ValuesAndLevelAndMember.endValuesAndLevelAndMember(&fbb, start: __start)
  }
...
public struct openmeteo_sdk_ValuesUnitPressureLevelAndMember: FlatBufferObject, Verifiable {
  ...
  public var hasValues: Bool { let o = _accessor.offset(VTOFFSET.values.v); return o == 0 ? false : true }
  public var valuesCount: Int32 { let o = _accessor.offset(VTOFFSET.values.v); return o == 0 ? 0 : _accessor.vector(count: o) }
  public func values(at index: Int32) -> openmeteo_sdk_ValuesAndLevelAndMember? { let o = _accessor.offset(VTOFFSET.values.v); return o == 0 ? nil : openmeteo_sdk_ValuesAndLevelAndMember(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
  ...
  public static func createValuesUnitPressureLevelAndMember(
    ...
    let __start = openmeteo_sdk_ValuesUnitPressureLevelAndMember.startValuesUnitPressureLevelAndMember(&fbb)
    openmeteo_sdk_ValuesUnitPressureLevelAndMember.add(unit: unit, &fbb)
    openmeteo_sdk_ValuesUnitPressureLevelAndMember.addVectorOf(values: values, &fbb)
    return openmeteo_sdk_ValuesUnitPressureLevelAndMember.endValuesUnitPressureLevelAndMember(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.unit.p, fieldName: "unit", required: false, type: openmeteo_sdk_SiUnit.self)
    try _v.visit(field: VTOFFSET.values.p, fieldName: "values", required: false, type: ForwardOffset<Vector<ForwardOffset<openmeteo_sdk_ValuesAndLevelAndMember>, openmeteo_sdk_ValuesAndLevelAndMember>>.self)
    _v.finish()
  }
}
